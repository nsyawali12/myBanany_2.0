...
public class ClientActivity extends AppCompatActivity {
    ...
    /* renamed from: com.madyapadmaonline.mybanany.mybanany.ClientActivity$1 */
    ...
    public void exitHandler() {
        new Builder(this).setIcon(C0322R.drawable.alert).setTitle("Disconnect?").setMessage("Are you sure you want to disconnect from the server?").setPositiveButton("Yes", new C03101()).setNegativeButton("No", null).show();
    }
}
