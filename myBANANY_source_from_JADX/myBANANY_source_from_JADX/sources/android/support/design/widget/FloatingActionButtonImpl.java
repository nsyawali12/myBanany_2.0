...
class FloatingActionButtonImpl {
    ...
    class C00353 implements OnPreDrawListener {
        C00353() {
        }
    ...
    CircularBorderDrawable createBorderDrawable(int borderWidth, ColorStateList backgroundTint) {
        ...
        borderDrawable.setGradientColors(ContextCompat.getColor(context, C0013R.color.design_fab_stroke_top_outer_color), ContextCompat.getColor(context, C0013R.color.design_fab_stroke_top_inner_color), ContextCompat.getColor(context, C0013R.color.design_fab_stroke_end_inner_color), ContextCompat.getColor(context, C0013R.color.design_fab_stroke_end_outer_color));
    ...
    private void ensurePreDrawListener() {
        if (this.mPreDrawListener == null) {
            this.mPreDrawListener = new C00353();
        }
    }
