...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C04281();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C04292();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C03843();

    /* renamed from: android.support.v7.app.WindowDecorActionBar$3 */
    class C03843 implements ViewPropertyAnimatorUpdateListener {
        C03843() {
        }
    ...
    class C04281 extends ViewPropertyAnimatorListenerAdapter {
        C04281() {
        }
    ...
    class C04292 extends ViewPropertyAnimatorListenerAdapter {
        C04292() {
        }
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0239R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0239R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0239R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0239R.id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0239R.styleable.ActionBar, C0239R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0239R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0239R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0239R.attr.actionBarWidgetTheme, outValue, true);
