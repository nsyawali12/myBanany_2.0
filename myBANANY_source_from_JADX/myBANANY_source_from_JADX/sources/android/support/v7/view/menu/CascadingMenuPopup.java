...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, OnKeyListener, OnDismissListener {
    ...
    private final OnAttachStateChangeListener mAttachStateChangeListener = new C02452();
    private final Context mContext;
    private int mDropDownGravity = 0;
    private boolean mForceShowIcon;
    private final OnGlobalLayoutListener mGlobalLayoutListener = new C02441();
    private boolean mHasXOffset;
    private boolean mHasYOffset;
    private int mLastPosition;
    private final MenuItemHoverListener mMenuItemHoverListener = new C03903();
    ...
    class C02441 implements OnGlobalLayoutListener {
        C02441() {
        }
    ...
    class C02452 implements OnAttachStateChangeListener {
        C02452() {
        }
    ...
    class C03903 implements MenuItemHoverListener {
        C03903() {
        }
    ...
    public CascadingMenuPopup(@NonNull Context context, @NonNull View anchor, @AttrRes int popupStyleAttr, @StyleRes int popupStyleRes, boolean overflowOnly) {
        ...
        this.mMenuMaxWidth = Math.max(res.getDisplayMetrics().widthPixels / 2, res.getDimensionPixelSize(C0239R.dimen.abc_config_prefDialogWidth));
    ...
    private void showMenu(@NonNull MenuBuilder menu) {
        ...
        if (parentInfo == null && this.mShowTitle && menu.getHeaderTitle() != null) {
            View titleItemView = (FrameLayout) inflater.inflate(C0239R.layout.abc_popup_menu_header_item_layout, listView, false);
