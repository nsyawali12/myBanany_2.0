...
public class ActionMenuItemView extends AppCompatTextView implements ItemView, OnClickListener, ActionMenuChildView {
    ...
    public ActionMenuItemView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0239R.styleable.ActionMenuItemView, defStyle, 0);
        this.mMinWidth = a.getDimensionPixelSize(C0239R.styleable.ActionMenuItemView_android_minWidth, 0);
        a.recycle();
    ...
    private boolean shouldAllowTextWithIcon() {
        ...
        return widthDp >= NNTPReply.AUTHENTICATION_REQUIRED || ((widthDp >= 640 && config.screenHeightDp >= NNTPReply.AUTHENTICATION_REQUIRED) || config.orientation == 2);
    }
