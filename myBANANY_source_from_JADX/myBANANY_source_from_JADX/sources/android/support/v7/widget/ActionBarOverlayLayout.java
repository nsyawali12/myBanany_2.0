...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = new int[]{C0239R.attr.actionBarSize, 16842841};
    ...
    class C02521 extends AnimatorListenerAdapter {
        C02521() {
        }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C02521();
        this.mRemoveActionBarHideOffset = new C02532();
        this.mAddActionBarHideOffset = new C02543();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0239R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0239R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0239R.id.action_bar));
        }
    }
