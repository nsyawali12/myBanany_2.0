...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C01131();
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C03542();

    /* renamed from: android.support.v4.content.ModernAsyncTask$1 */
    static class C01131 implements ThreadFactory {
    ...
    class C03542 extends WorkerRunnable<Params, Result> {
        C03542() {
        }
