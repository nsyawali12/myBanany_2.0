...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C01951();
    ...
    private static final Interpolator sInterpolator = new C01962();
    ...
    private final Runnable mEndScrollRunnable = new C01973();
    ...
    static class C01951 implements Comparator<ItemInfo> {
        C01951() {
        }
    ...
    static class C01962 implements Interpolator {
        C01962() {
        }
    ...
    class C01973 implements Runnable {
        C01973() {
        }
    ...
    class C03744 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = new C01981();
        Parcelable adapterState;
        ClassLoader loader;
        int position;

        /* renamed from: android.support.v4.view.ViewPager$SavedState$1 */
        static class C01981 implements ClassLoaderCreator<SavedState> {
            C01981() {
            }
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C03744());
    }
