...
public final class TimeUDPClient extends DatagramSocketClient {
    ...
    public long getTime(InetAddress host, int port) throws IOException {
        ...
        return (((0 | (((long) ((this.__timeData[0] & 255) << 24)) & 4294967295L)) | (((long) ((this.__timeData[1] & 255) << 16)) & 4294967295L)) | (((long) ((this.__timeData[2] & 255) << 8)) & 4294967295L)) | (((long) (this.__timeData[3] & 255)) & 4294967295L);
    }
