...
public class ForegroundLinearLayout extends LinearLayoutCompat {
    ...
    public ForegroundLinearLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mForegroundGravity = NNTP.DEFAULT_PORT;
        this.mForegroundInPadding = true;
        this.mForegroundBoundsChanged = false;
        TypedArray a = context.obtainStyledAttributes(attrs, C0013R.styleable.ForegroundLinearLayout, defStyle, 0);
        this.mForegroundGravity = a.getInt(C0013R.styleable.ForegroundLinearLayout_android_foregroundGravity, this.mForegroundGravity);
        Drawable d = a.getDrawable(C0013R.styleable.ForegroundLinearLayout_android_foreground);
        if (d != null) {
            setForeground(d);
        }
        this.mForegroundInPadding = a.getBoolean(C0013R.styleable.ForegroundLinearLayout_foregroundInsidePadding, true);
        a.recycle();
    }
    ...
    public void setForegroundGravity(int foregroundGravity) {
        if (this.mForegroundGravity != foregroundGravity) {
            ...
            if (this.mForegroundGravity == NNTP.DEFAULT_PORT && this.mForeground != null) {
    ...
    public void setForeground(Drawable drawable) {
        if (this.mForeground != drawable) {
            ...
            if (drawable != null) {
                ...
                if (this.mForegroundGravity == NNTP.DEFAULT_PORT) {
