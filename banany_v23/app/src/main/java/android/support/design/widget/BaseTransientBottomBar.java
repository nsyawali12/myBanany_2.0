...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    final Callback mManagerCallback = new C03333();
    ...
    static class SnackbarBaseLayout extends FrameLayout {
        ...
        SnackbarBaseLayout(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray a = context.obtainStyledAttributes(attrs, C0013R.styleable.SnackbarLayout);
            if (a.hasValue(C0013R.styleable.SnackbarLayout_elevation)) {
                ViewCompat.setElevation(this, (float) a.getDimensionPixelSize(C0013R.styleable.SnackbarLayout_elevation, 0));
            }
            a.recycle();
            setClickable(true);
        }
    ...
    class C03322 implements OnApplyWindowInsetsListener {
        C03322() {
        }
    ...
    class C03344 implements OnDismissListener {
        C03344() {
        }
    ...
    class C03355 implements OnAttachStateChangeListener {
        ...
        public void onViewDetachedFromWindow(View v) {
            if (BaseTransientBottomBar.this.isShownOrQueued()) {
                BaseTransientBottomBar.sHandler.post(new C00221());
            }
        }
    }

    /* renamed from: android.support.design.widget.BaseTransientBottomBar$6 */
    class C03366 implements OnLayoutChangeListener {
        C03366() {
        }
    ...
    protected BaseTransientBottomBar(@NonNull ViewGroup parent, @NonNull View content, @NonNull ContentViewCallback contentViewCallback) {
        if (parent == null) {
            ...
            this.mView = (SnackbarBaseLayout) LayoutInflater.from(this.mContext).inflate(C0013R.layout.design_layout_snackbar, this.mTargetParent, false);
            ...
            ViewCompat.setOnApplyWindowInsetsListener(this.mView, new C03322());
    ...
    final void showView() {
        if (this.mView.getParent() == null) {
            ...
            if (lp instanceof CoordinatorLayout.LayoutParams) {
                ...
                behavior.setListener(new C03344());
                clp.setBehavior(behavior);
                clp.insetEdge = 80;
            }
            this.mTargetParent.addView(this.mView);
        }
        this.mView.setOnAttachStateChangeListener(new C03355());
        if (!ViewCompat.isLaidOut(this.mView)) {
            this.mView.setOnLayoutChangeListener(new C03366());
    ...
    void animateViewIn() {
        if (VERSION.SDK_INT >= 12) {
            ...
            animator.addListener(new C00237());
        ...
        Animation anim = AnimationUtils.loadAnimation(this.mView.getContext(), C0013R.anim.design_snackbar_in);
        anim.setInterpolator(AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
        anim.setDuration(250);
        anim.setAnimationListener(new C00259());
    ...
    private void animateViewOut(final int event) {
        ...
        Animation anim = AnimationUtils.loadAnimation(this.mView.getContext(), C0013R.anim.design_snackbar_out);
        anim.setInterpolator(AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
        anim.setDuration(250);
