...
public class ScrimInsetsFrameLayout extends FrameLayout {
    ...
    class C03301 implements OnApplyWindowInsetsListener {
        C03301() {
        }
    ...
    public ScrimInsetsFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0013R.styleable.ScrimInsetsFrameLayout, defStyleAttr, C0013R.style.Widget_Design_ScrimInsetsFrameLayout);
        this.mInsetForeground = a.getDrawable(C0013R.styleable.ScrimInsetsFrameLayout_insetForeground);
        a.recycle();
        setWillNotDraw(true);
        ViewCompat.setOnApplyWindowInsetsListener(this, new C03301());
    }
