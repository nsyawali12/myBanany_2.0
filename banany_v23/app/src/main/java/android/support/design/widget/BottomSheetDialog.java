...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    class C00303 implements OnTouchListener {
        C00303() {
        }
    ...
    class C03392 extends AccessibilityDelegateCompat {
        C03392() {
        }
    ...
    class C03404 extends BottomSheetCallback {
        C03404() {
        }
    ...
    public BottomSheetDialog(@NonNull Context context, @StyleRes int theme) {
        ...
        this.mBottomSheetCallback = new C03404();
    ...
    private View wrapInBottomSheet(int layoutResId, View view, LayoutParams params) {
        FrameLayout container = (FrameLayout) View.inflate(getContext(), C0013R.layout.design_bottom_sheet_dialog, null);
        CoordinatorLayout coordinator = (CoordinatorLayout) container.findViewById(C0013R.id.coordinator);
        if (layoutResId != 0 && view == null) {
            view = getLayoutInflater().inflate(layoutResId, coordinator, false);
        }
        FrameLayout bottomSheet = (FrameLayout) coordinator.findViewById(C0013R.id.design_bottom_sheet);
        ...
        coordinator.findViewById(C0013R.id.touch_outside).setOnClickListener(new C00291());
        ViewCompat.setAccessibilityDelegate(bottomSheet, new C03392());
        bottomSheet.setOnTouchListener(new C00303());
        return container;
    }
    ...
    private static int getThemeResId(Context context, int themeId) {
        ...
        if (context.getTheme().resolveAttribute(C0013R.attr.bottomSheetDialogTheme, outValue, true)) {
            return outValue.resourceId;
        }
        return C0013R.style.Theme_Design_Light_BottomSheetDialog;
    }
}
