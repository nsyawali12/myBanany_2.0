...
public abstract class AbsSavedState implements Parcelable {
    public static final Creator<AbsSavedState> CREATOR = new C01872();
    public static final AbsSavedState EMPTY_STATE = new C03731();
    private final Parcelable mSuperState;

    /* renamed from: android.support.v4.view.AbsSavedState$2 */
    static class C01872 implements ClassLoaderCreator<AbsSavedState> {
        C01872() {
        }
    ...
    static class C03731 extends AbsSavedState {
        C03731() {
            super();
        }
    }
