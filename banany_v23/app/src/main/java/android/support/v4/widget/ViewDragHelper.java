...
public class ViewDragHelper {
    ...
    private static final Interpolator sInterpolator = new C02221();
    ...
    private final Runnable mSetIdleRunnable = new C02232();
    private int mTouchSlop;
    private int mTrackingEdges;
    private VelocityTracker mVelocityTracker;

    /* renamed from: android.support.v4.widget.ViewDragHelper$1 */
    static class C02221 implements Interpolator {
        C02221() {
        }
