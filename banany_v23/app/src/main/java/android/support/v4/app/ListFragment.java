...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C01112();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C01101();
    ...
    class C01112 implements OnItemClickListener {
        C01112() {
        }
