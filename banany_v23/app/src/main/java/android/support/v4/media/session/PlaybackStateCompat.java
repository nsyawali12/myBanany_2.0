...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final Creator<PlaybackStateCompat> CREATOR = new C01591();
    ...
    static class C01591 implements Creator<PlaybackStateCompat> {
        C01591() {
        }
    ...
    public static final class CustomAction implements Parcelable {
        public static final Creator<CustomAction> CREATOR = new C01601();
        ...
        static class C01601 implements Creator<CustomAction> {
            C01601() {
            }
