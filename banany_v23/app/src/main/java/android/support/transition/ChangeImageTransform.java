...
public class ChangeImageTransform extends Transition {
    ...
    private static final TypeEvaluator<Matrix> NULL_MATRIX_EVALUATOR = new C00661();
    ...
    static class C00661 implements TypeEvaluator<Matrix> {
        C00661() {
        }
    ...
    private static Matrix copyImageMatrix(ImageView view) {
        switch (C00683.$SwitchMap$android$widget$ImageView$ScaleType[view.getScaleType().ordinal()]) {
            case 1:
