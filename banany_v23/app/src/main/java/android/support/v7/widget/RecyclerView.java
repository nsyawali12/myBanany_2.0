...
import android.support.v7.recyclerview.C0240R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    static final Interpolator sQuinticInterpolator = new C02803();
    ...
    static class C02803 implements Interpolator {
        C02803() {
        }
    ...
    public static abstract class LayoutManager {
        ...
        private final Callback mHorizontalBoundCheckCallback = new C04041();
        ...
        private final Callback mVerticalBoundCheckCallback = new C04052();
        private int mWidth;
        ...
        class C04052 implements Callback {
            C04052() {
            }
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0240R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0240R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0240R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0240R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0240R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    ...
    class C04014 implements ProcessCallback {
        C04014() {
        }
    ...
    class C04025 implements Callback {
        C04025() {
        }
    ...
    class C04036 implements Callback {
        C04036() {
        }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mUpdateChildViewsRunnable = new C02781();
        ...
        this.mItemAnimatorRunner = new C02792();
        this.mViewInfoProcessCallback = new C04014();
        if (attrs != null) {
        ...
        if (attrs != null) {
            a = context.obtainStyledAttributes(attrs, C0240R.styleable.RecyclerView, defStyle, 0);
            String layoutManagerName = a.getString(C0240R.styleable.RecyclerView_layoutManager);
            if (a.getInt(C0240R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
                setDescendantFocusability(262144);
            }
            this.mEnableFastScroller = a.getBoolean(C0240R.styleable.RecyclerView_fastScrollEnabled, false);
            if (this.mEnableFastScroller) {
                initFastScroller((StateListDrawable) a.getDrawable(C0240R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), a.getDrawable(C0240R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) a.getDrawable(C0240R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), a.getDrawable(C0240R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
            a.recycle();
    ...
    private String getFullClassName(Context context, String className) {
        if (className.charAt(0) == FilenameUtils.EXTENSION_SEPARATOR) {
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C04025());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C04036());
    }
    ...
    void initFastScroller(StateListDrawable verticalThumbDrawable, Drawable verticalTrackDrawable, StateListDrawable horizontalThumbDrawable, Drawable horizontalTrackDrawable) {
        ...
        FastScroller fastScroller = new FastScroller(this, verticalThumbDrawable, verticalTrackDrawable, horizontalThumbDrawable, horizontalTrackDrawable, resources.getDimensionPixelSize(C0240R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0240R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0240R.dimen.fastscroll_margin));
    }
