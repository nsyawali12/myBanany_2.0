...
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find block by offset: 0x0012 in list [B:5:0x000f]
	...
	at jadx.api.JadxDecompiler$$Lambda$8/1169794610.run(Unknown Source)
*/
        /*
        r7 = this;
        r3 = 0;
    ...
    void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(attrs, C0239R.styleable.AppCompatTextView, defStyleAttr, 0);
        if (a.hasValue(C0239R.styleable.AppCompatTextView_autoSizeTextType)) {
            this.mAutoSizeTextType = a.getInt(C0239R.styleable.AppCompatTextView_autoSizeTextType, 0);
        }
        if (a.hasValue(C0239R.styleable.AppCompatTextView_autoSizeStepGranularity)) {
            autoSizeStepGranularityInPx = a.getDimension(C0239R.styleable.AppCompatTextView_autoSizeStepGranularity, UNSET_AUTO_SIZE_UNIFORM_CONFIGURATION_VALUE);
        }
        if (a.hasValue(C0239R.styleable.AppCompatTextView_autoSizeMinTextSize)) {
            autoSizeMinTextSizeInPx = a.getDimension(C0239R.styleable.AppCompatTextView_autoSizeMinTextSize, UNSET_AUTO_SIZE_UNIFORM_CONFIGURATION_VALUE);
        }
        if (a.hasValue(C0239R.styleable.AppCompatTextView_autoSizeMaxTextSize)) {
            autoSizeMaxTextSizeInPx = a.getDimension(C0239R.styleable.AppCompatTextView_autoSizeMaxTextSize, UNSET_AUTO_SIZE_UNIFORM_CONFIGURATION_VALUE);
        }
        if (a.hasValue(C0239R.styleable.AppCompatTextView_autoSizePresetSizes)) {
            int autoSizeStepSizeArrayResId = a.getResourceId(C0239R.styleable.AppCompatTextView_autoSizePresetSizes, 0);
